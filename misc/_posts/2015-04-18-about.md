...
Original sources for photo banner on homepage:<br/>
...
Photo #3 - A screenshot of the "bubble chart" tool from the [Phinch data visualization framework] (software developed in the Bik Lab)
